...
class Department(models.Model):
    ...
    # Circular FK to Employee (defined later) - using string reference
...
class Position(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Inactive positions are archived but not deleted."
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class Employee(models.Model):
    ...
    email = models.EmailField(
        unique=True,
        help_text="Corporate email address used for all notifications."
    )
    ...
    date_of_birth = models.DateField(
        null=True,
        blank=True,
        help_text="Used for age verification and HR compliance."
    )
    ...
    hire_date = models.DateField(
        help_text="Official start date of employment."
    )
