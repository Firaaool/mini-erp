...
class AttendanceRecord(models.Model):
    ...
    STANDARD_HOURS = Decimal('8.00')  # Standard working day length
    ...
    date = models.DateField(
        help_text="Calendar date of this attendance entry. "
    ...
    check_out = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Exact timestamp when the employee clocked out. "
                  "Null if the employee has not yet checked out."
    )
    working_hours = models.DecimalField(
        ...
        blank=True,
        editable=False,
        help_text="Computed hours worked (check_out - check_in). "
    ...
    overtime_hours = models.DecimalField(
        ...
        blank=True,
        editable=False,
        help_text="Hours worked beyond STANDARD_HOURS (8 hrs). "
